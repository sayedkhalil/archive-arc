...
<div className="col-6 col-lg-2 p-2 ">
        ...
        <p className="text-center border-card  py-3 box p-1 text-light bg2">جميع الطلبات <i className="far fa-file-alt me-3"></i></p>
         ...
         <div className="col-6 col-lg-2 p-2 ">
        <p className="text-center bg-cards h3 fs-3 p-2 mt-1 ">{props.data.filter(x=>x.action=="0").length}</p>
        <p className="text-center border-card py-3 box p-1 text-light bg0 box ">طلبات جديدة <i className="far fa-file-alt me-3"></i></p>
        </div>
        <div className="col-6 col-lg-2 p-2 ">
        <p className="text-center h3 bg-cards fs-3 p-2 mt-1 ">{props.data.filter(x=>x.action=="1").length}</p>
        <p className="text-center border-card py-3 box p-1 text-light  bg1">تحت الاجراء<i className="far fa-file-alt me-3"></i></p>
        </div>   
        <div className="col-6 col-lg-2 p-2 ">
        <p className="text-center h3 bg-cards fs-3 haaa1 p-2 mt-1 ">{props.data.filter(x=>x.action=="3").length}</p>
        <p className="text-center border-card py-3  box p-1 text-light bg3  ">تم الاعتماد<i className="far fa-file-alt me-3"></i></p>
        </div> 
        <div className="col-6 col-lg-2 p-2 ">
        <p className="text-center h3 bg-cards fs-3 haaa2 p-2 mt-1 ">{props.data.filter(x=>x.action=="2").length}</p>
        <p className="text-center border-card py-3 box p-1 text-light bg4 ">معاد تقديمه<i className="far fa-file-alt me-3"></i></p>
        </div>
     
        <div className="col-6 col-lg-2 p-2 ">
        <p className="text-center h3 bg-cards fs-3 p-2 mt-1 ">{props.data.filter(x=>x.action=="5").length}</p>
        <p className="text-center box  border-card py-3 p-1 text-light bg-secondary ">مرفوض ولا يعاد تقديمه <i className="far fa-file-alt me-3"></i></p>
        </div>
</div>
    );
}
